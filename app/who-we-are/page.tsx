    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Gary */}
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="w-12 h-12 rounded-full bg-purple-50 flex items-center justify-center text-purple-600 font-bold text-lg mb-4">GW</div>
            <div className="text-base font-bold text-gray-900">Gary Walter</div>
            <div className="text-sm text-blue-600 font-medium mt-1 mb-3">Strategic Partner</div>
            <p className="text-sm font-light text-gray-500 leading-relaxed">Former CEO who led a data intelligence company from $1M to $250M — with the Costa Rica team at the core of that growth. Brings the operator perspective of someone who has lived the model from the client side.</p>
          </div>
